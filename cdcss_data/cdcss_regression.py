...
def regressionModel(provinces, userData):
  ...
  population_2023 = populationCalculator(userData)
...
def main():
    # heart failure example: /Users/hashir/Documents/GitHub/mssmethacks/data/PHAC_Infobase_CCDSS_Detailed-8585182709302454740.csv
    parsedData = parseFile('/Users/hashir/Documents/GitHub/mssmethacks/cdcss_data/csv/PHAC_Infobase_CCDSS_Detailed-8585182797961006365.csv')
    groupData = regressionModel(parsedData, ['Ontario', 'Males', '20-34'])
    print(groupData)
